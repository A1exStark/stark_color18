...
$(function() {
	...
	$('#color-10').addClass('dnone');
	$('#color-28').addClass('dnone');
	$('#color-30').addClass('dnone');
	$('#color-gloss').addClass('dnone');
	$('#color-satin').addClass('dnone');
	$('.s-ceil').addClass('dnone');
	$('#s-standart-standart').removeClass('dnone');	
...
*/
		...
		$('#price-ceil').click(function(){
			$('#color-ceil').colorbox({
				inline:true,
			});
			$('#color-10').removeClass('dnone');
			$('#color-26').addClass('dnone');
			$('#color-28').addClass('dnone');
			$('#color-30').addClass('dnone');
	...
	$('#m-gloss').change( function() {
		...
		if(value == 28) {
			color = '#ffffff';	
			draw = new PolygonCanvas('c-ceil');
			draw.Polygon(coordArray['ceil']);
			draw.SetBgColor(color);
			$('#s-gloss').removeClass('dnone');	
			$('#color-28').removeClass('dnone');
			$('#color-10').addClass('dnone');
			$('#color-26').addClass('dnone');
			$('#color-30').addClass('dnone');
		} else if(value ==30){
	...
	$('#m-ceil-type').change( function() {
		...
		$('.s-ceil').addClass('dnone');
		$('#s-'+ceil+'-standart').removeClass('dnone');	
		$('#m-lamp').val(0).trigger('change');
	});	

																																	/*выбор фактуры 2 уровня*/
	$('#m-gloss2').change( function() {
		ceil2 = $(this).val();
		
		$('.s-ceil').addClass('dnone');
		$('#s-'+ceil+'-'+ceil2).removeClass('dnone');
		$('#color-'+ceil2).removeClass('dnone');
		$('#s-'+ceil+'-'+ceil2).removeClass('dnone');
		$('#m-lamp').val(0).trigger('change');	
	});	
